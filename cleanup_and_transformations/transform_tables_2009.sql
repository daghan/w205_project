--
-- DROP TABLE storms_2009_clean;
-- CREATE TABLE storms_2009_clean AS
-- SELECT  episode_id,
--         end_day,
...
-- FROM storms_2009;
--
-- ALTER TABLE storms_2009_clean
-- SET SERDEPROPERTIES ('serialization.null.format' = '');
--
--
-- DROP TABLE storms_2009_clean_aggregate;
-- CREATE TABLE storms_2009_clean_aggregate AS
...
-- FROM storms_2009_clean
-- GROUP BY end_quarter, end_year, state
-- ORDER BY state, end_quarter,end_year;


DROP TABLE all_states_2009_clean;
CREATE TABLE all_states_2009_clean AS
...
FROM all_states_2009;
ALTER TABLE all_states_2009_clean
SET SERDEPROPERTIES ('serialization.null.format' = '');

--
-- select count(*) from storms_2009_clean_aggregate;
select count(*) from all_states_2009_clean;
